...
/**
 * \file    test/phpunit/ReservasHotelFunctionalTest.php
...
/**
 * Class ReservasHotelFunctionalTest
 *
 ...
 *
 * @package Testreservashotel
 */
class ReservasHotelFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modReservasHotel')->click();
		} else {
			// Disable the module
			$this->byHref('modReservasHotel')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/reservashotel/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('reservashotel/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/reservashotel/admin/about.php');
		$this->authenticate();
		return $this->assertContains('reservashotel/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('reservashotelwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modReservasHotel_ReservasHotelTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modReservasHotel_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
