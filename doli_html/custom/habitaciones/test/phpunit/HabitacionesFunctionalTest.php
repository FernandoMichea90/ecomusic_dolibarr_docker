...
/**
 * \file    test/phpunit/HabitacionesFunctionalTest.php
...
/**
 * Class HabitacionesFunctionalTest
 *
 ...
 *
 * @package Testhabitaciones
 */
class HabitacionesFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modHabitaciones')->click();
		} else {
			// Disable the module
			$this->byHref('modHabitaciones')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/habitaciones/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('habitaciones/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/habitaciones/admin/about.php');
		$this->authenticate();
		return $this->assertContains('habitaciones/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('habitacioneswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modHabitaciones_HabitacionesTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modHabitaciones_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
