...
/**
 * \file    test/phpunit/CategoriasFunctionalTest.php
 * \ingroup categorias
...
/**
 * Class CategoriasFunctionalTest
 *
 ...
 *
 * @package Testcategorias
 */
class CategoriasFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modCategorias')->click();
		} else {
			// Disable the module
			$this->byHref('modCategorias')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/categorias/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('categorias/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/categorias/admin/about.php');
		$this->authenticate();
		return $this->assertContains('categorias/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('categoriaswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modCategorias_CategoriasTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modCategorias_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
